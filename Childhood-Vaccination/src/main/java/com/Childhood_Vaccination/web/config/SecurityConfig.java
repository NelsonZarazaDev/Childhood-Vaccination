package com.Childhood_Vaccination.web.config;

import com.Childhood_Vaccination.web.exception.NotFoundException;
import com.Childhood_Vaccination.web.filter.JwtAuthenticationFilter;
...
public class SecurityConfig {
	...
	public UserDetailsService userDetailService() {
		return email -> vaccinatorRepository.findByEmail(email).orElseThrow(() ->
	...
	public CorsConfigurationSource corsConfigurationSource() {
		...
		configuration.addAllowedOrigin("http://192.168.56.1:3000/");
