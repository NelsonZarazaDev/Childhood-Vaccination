  ...
  return (
    <>
      <div className="flex flex-col h-screen m-auto justify-center items-center">
        <div className="flex text-[150px] md:text-[250px] font-bold">
          4
          <img
            className="brightness-100 saturate-150 drop-shadow-2xl animate-[flotar_2s_infinite_alternate_ease-in-out] w-56 md:w-auto"
            src={imgError}
            alt=""
          />
          4
